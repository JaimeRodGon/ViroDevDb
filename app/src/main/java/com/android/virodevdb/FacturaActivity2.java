...
public class FacturaActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nueva_factura2);
    ...
    private void Setup (){
        ...
        //Listener botones
        btnGuardar.setOnClickListener(new FacturaActivity2.listenerGuardar());
        btnCancelar.setOnClickListener(new FacturaActivity2.listenerCancelar());
    }
    //Boton Guardar
